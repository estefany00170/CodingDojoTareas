...
class User:
    ...
    def make_withdrawal(self, amount):
        self.balance-= amount
        return self #el return self es para que pueda encadenar
...
guido.make_deposit(100).make_deposit(120).make_deposit(500).make_withdrawal(70).show_user_balance()
print('----------------------------')

#Haz que el segundo usuario haga 2 depósitos y 2 giros, y luego muestra sus balances
ricardo.make_deposit(250).make_deposit(480).make_withdrawal(100).make_withdrawal(30).show_user_balance()
print('------------------------------')

#Haz que el tercer usuario haga 1 depósito y 3 giros, y luego muestra sus balance
Mary.make_deposit(500).make_withdrawal(50).make_withdrawal(80).make_withdrawal(80).show_user_balance()
print('---------------------------')
...
guido.transfer_money(Mary, 20).show_user_balance()
